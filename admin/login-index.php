...
<?PHP  include "config.php"; ?>
    ...
    <h2 style="text-decoration:underline;color:#acbfa9">Login_Page</h2>
    ...
    $query = "SELECT uid,username,role,password FROM user WHERE username = '$username' AND password = '$password'";
